...
contract("NodeRulesList (list manipulation)", async () => {
  ...
  it("should calculate same key for same enode", async () => {
    let key1 = new BN(await rulesListContract._calculateKey(node1High, node1Host, node1Port));
    let key2 = new BN(await rulesListContract._calculateKey(node1High, node1Host, node1Port));
  ...
  it("should calculate different key for different enode", async () => {
    let key1 = new BN(await rulesListContract._calculateKey(node1High, node1Host, node1Port));
    let key2 = new BN(await rulesListContract._calculateKey(node2High, node2Host, node2Port));
  ...
  it("size method reflect list size", async () => {
    await rulesListContract._add(node1High, node1Host, node1Port);
    await rulesListContract._add(node2High, node2Host, node2Port);
    await rulesListContract._add(node3High, node3Host, node3Port);
  ...
  it("exists should return true for existing address", async () => {
    ...
    let exists = await rulesListContract._exists(node1High, node1Host, node1Port);
  ...
  it("exists should return false for absent address", async () => {
    ...
    let exists = await rulesListContract._exists(node2High, node2Host, node2Port);
  ...
  it("add enode to list should add node to the list and increase list size", async () => {
    ...
    exists = await rulesListContract._exists(node1High, node1Host, node1Port);
    assert.ok(exists);
  ...
  it("remove absent enode should not fail", async () => {
    let txResult = await rulesListContract._remove(node1High, node1Host, node1Port);
  ...
  it("remove enode from list should remove enode from list and decrease list size", async () => {
    ...
    await rulesListContract._remove(node1High, node1Host, node1Port);
