...
var enode2 = "0x892092b7fcb320c1b62f3759bd359fdc3a2ed5df436c3d8914b1532740128929"
...
contract ("Node Ingress (no contracts registered)", (accounts) => {
    ...
    it("should forbid any connection if rules contract has not been registered", async () => {
        ...
        let permitted = await nodeIngressContract.connectionAllowed(enode1, nodeHost, nodePort, enode2, node2Host, node2Port);
