...
import { TargetDataProvider } from '../../context/targetData';
...
import TargetTab from '../../containers/Tabs/Target';
...
// Constants
import { ACCOUNT_TAB,TARGET_TAB, ADMIN_TAB, ENODE_TAB } from '../../constants/tabs';
    ...
    <TabSelector setTab={setTab} tab={tab} />
    {
      <ToastProvider>
        ...
        <AdminDataProvider>
          ...
          <TargetDataProvider>
            <TargetTab isOpen={tab === TARGET_TAB} />
          </TargetDataProvider>
