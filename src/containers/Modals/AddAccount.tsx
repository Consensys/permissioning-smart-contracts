...
const AddModalContainer: React.FC<{
  ...
  const modifyMembresiaType = ({ target: { value } }: { target: { value: string } }) => {
   // const validation = isValid(value);

   setMembresiaType(value);
   // setValidation(validation);
  };
  ...
  return (
    <AddModal
      input={input}
      membresiaType={membresiaType}
      validationResult={validation}
      modifyInput={modifyInput}
      modifyMembresiaType={modifyMembresiaType}
